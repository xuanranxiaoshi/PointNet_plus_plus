# -*— coding = utf-8 -*-
# @Time : 2022-05-02 9:57
# @Author : Csc
# @File : pointnet2_cls_ssg.py
# @Software : PyCharm
...
class get_model(nn.Module):
    def __init__(self, num_class, normal_channel=True):
        ...
        in_channel = 6 if normal_channel else 3  # 有法线信息通道是6，否则就是3
        self.normal_channel = normal_channel
        """这里网络的输入点集的特征是坐标拼接了其他特征的"""
    ...
    def forward(self, xyz):
        ...
        x = l3_points.view(B, 1024)  # 获得每个领域的全局特征
